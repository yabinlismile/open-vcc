---
title: "Authenticate Requests with HMAC Signing"
sidebarTitle: "Authentication"
description: "ByCard uses HMAC-SHA256 request signing. Learn how to build the signature string, set Authorization headers, and rotate keys safely."
---
